...
const DashboardPage = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-400 text-center mb-6">Your account is set up and ready to go</p>
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <p className="text-gray-300">
            ...
            <span className={user.is_verified || user.isVerified ? "text-green-400" : "text-red-400"}>
              {user.is_verified || user.isVerified ? "Yes ✓" : "No ✗"}
            </span>
          </p>
        </motion.div>
      </div>
